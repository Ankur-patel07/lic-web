...
<head>
    ...
    <title>Child Merriage Fund</title>
    <!-- favicons Icons -->
                        ...
                        <div class="about-one__left">
                            <div class="about-one__img-box wow slideInLeft" data-wow-delay="100ms"
                                ...
                                <div class="about-one__img">
                                    <img src="assets/images/services/mrg1.png" alt="">
                                </div>
                    ...
                    <div class="col-xl-6">
                        <div class="about-one__right">
                            <div class="section-title text-left">
                                ...
                                <h2 class="section-title__title mt-5">Child Marriage Fund</h2>
                            </div>
                         
                            <ul class="list-unstyled about-one__points mt-3">
                          <p style="font-size:20px;"> It is the dream of every parent to marry their child with pomp, if the marriage of the children is to be done according to the happiness of the children, then when the children are 0 to 5 years old, you start saving a separate fund for them, then your dreams will come true. will happen royal marriage. </p>
