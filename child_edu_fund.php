...
<head>
    ...
    <title>Child Education Fund </title>
    <!-- favicons Icons -->
                        ...
                        <div class="about-one__left">
                            <div class="about-one__img-box wow slideInLeft" data-wow-delay="100ms"
                                ...
                                <div class="about-one__img">
                                    <img src="assets/images/resources/child_edu_fund.jpg" alt="">
                                </div>
                    ...
                    <div class="col-xl-6">
                        <div class="about-one__right">
                            <div class="section-title text-left">
                                ...
                                <h2 class="section-title__title mt-5">Child Education Fund
    </h2>
                            </div>
                         
                            <ul class="list-unstyled about-one__points mt-3">
                                        <p style="font-size:20px;"> Child education fund is a financial investment,
    which is especially useful in covering the expenses of children's education,
In which you can use towards children's higher education expenses,
Helping to make the future of children bright.</p>
