...
<head>
    ...
    <title> About || Shree Krishna Life Care </title>
    <!-- favicons Icons -->
                ...
                <div class="row">
                    ...
                    <div class="col-xl-6">
                        <div class="about-four__right">
                            ...
                            I am VIPUL B. PATEL cfn expert mdrt chife life insurence adviser connected to ahemdabad city branch.</p>
                            <p class="about-four__text-2">Present I am serving more than 905 satisfied customers. My goal is customer satisfaction and to sale only need base insurance to my customers. I am also giving service for life insurance, Mediclaim, general insurance, mutual funds ( sip ) I am sure you will give me chance to serve you.</p>
                            <p class="about-four__text-2">I shall be very glad to provide you various information about lic products as well as general insurance and mutual fund products.</p>
                            <p class="about-four__text-2">LIC, BAJAJ, TATA, HDFC, STAR, CARE.</p>
                            ...
                            <div class="testimonial-two__point-box">
                                ...
                                <ul class="list-unstyled testimonial-two__point testimonial-two__point-two">
                                    ...
                                    <li>
                                        ...
                                        <div class="text">
                                            <p>We’re give quick and <br> reliable
                                            insurance</p>
                                        </div>
                                    </li>
                                </ul>
                                    ...
                                    <div class="testimonial-two__single">
                                        <div class="testimonial-two__single-inner">
                                            ...
                                            <div class="testimonial-two__content-box">
                                                <h5 class="testimonial-two__client-name">Sagar Kothari</h5>
                                                <p class="testimonial-two__text-2">The best ever service provider in insurance industry.
Mr. Vipul you are Down to earth & Co-operative in nature. </p>
                                            </div>
                                    ...
                                    <div class="testimonial-two__single">
                                        <div class="testimonial-two__single-inner">
                                            ...
                                            <div class="testimonial-two__content-box">
                                                <h5 class="testimonial-two__client-name">Bhavesh Patel</h5>
                                                <p class="testimonial-two__text-2">Mr vipul is know what he is dealing with. Very human approach towards every requirments. Resputed persnality amongst the community. </p>
                                            </div>
                                            <div class="testimonial-two__client-review">
                                                <i class="fa fa-star"></i>
                                                <i class="fa fa-star"></i>
                                        ...
                                        <div class="testimonial-two__founder-box">
                                            <div class="testimonial-two__founder">
                                                <p class="testimonial-two__founder-text"></p>
                                                <div class="testimonial-two__founder-shape">
                                                    <img src="assets/images/shapes/testimonial-two-founder-shape.png"
                                                        alt="">
                                                </div>
                                ...
                                <div class="testimonial-two__wrap">
                                    <div class="testimonial-two__single">
                                        <div class="testimonial-two__single-inner">
                                            ...
                                            <div class="testimonial-two__content-box">
                                                <h5 class="testimonial-two__client-name">Rushit Patel</h5>
                                                <p class="testimonial-two__text-2">Helping nature of Vipul Patel and wonderful knowledge of all Financial services.</p>
                                            </div>
                                            <div class="testimonial-two__client-review">
                                                <i class="fa fa-star"></i>
                                                <i class="fa fa-star"></i>
                                    ...
                                    <div class="testimonial-two__single">
                                        <div class="testimonial-two__single-inner">
                                            ...
                                            <div class="testimonial-two__content-box">
                                                <h5 class="testimonial-two__client-name">Utpal V. Patel</h5>
                                                <p class="testimonial-two__text-2">Superb services, very good knowledge about all the possible ways which are usefull for us as a investor.</p>
                                            </div>
                                            <div class="testimonial-two__client-review">
                                                <i class="fa fa-star"></i>
                                                <i class="fa fa-star"></i>
                                ...
                                <div class="testimonial-two__wrap">
                                    <div class="testimonial-two__single">
                                        <div class="testimonial-two__single-inner">
                                            ...
                                            <div class="testimonial-two__content-box">
                                                <h5 class="testimonial-two__client-name">Darshan Dholakiya</h5>
                                                <p class="testimonial-two__text-2">knowledge About inaurance industries is very amazing and always gives a good suggestions..</p>
                                            </div>
                                            <div class="testimonial-two__client-review">
                                                <i class="fa fa-star"></i>
                                                <i class="fa fa-star"></i>
                                    ...
                                    <div class="testimonial-two__single">
                                        <div class="testimonial-two__single-inner">
                                            ...
                                            <div class="testimonial-two__content-box">
                                                <h5 class="testimonial-two__client-name">Ketan Akhaja</h5>
                                                <p class="testimonial-two__text-2">Best service in insurance industry as per your requirement...</p>
                                            </div>
                                            <div class="testimonial-two__client-review">
                                                <i class="fa fa-star"></i>
                                                <i class="fa fa-star"></i>
                ...
                <div class="cta-one__content">
                    <div class="cta-one__inner">
                        <div class="cta-one__left">
                            <h3 class="cta-one__title">Best financial planning for secure life and family</h3>
                        </div>
...
<?php require_once('footer.php');?>
    ...
    <div class="mobile-nav__wrapper">
        ...
        <div class="mobile-nav__content">
            ...
            <div class="logo-box">
                <a href="index-2.html" aria-label="logo image"><img src="assets/images/resources/logo-2.png" width="143"
                        alt=""></a>
            </div>
            <!-- /.logo-box -->
