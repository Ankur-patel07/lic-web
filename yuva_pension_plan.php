                        ...
                        <div class="about-one__left">
                            <div class="about-one__img-box wow slideInLeft" data-wow-delay="100ms"
                                ...
                                <div class="about-one__img">
                                    <img src="assets/images/resources/yuva_pension.jpg" alt="">
                                </div>
                    ...
                    <div class="col-xl-6">
                        <div class="about-one__right">
                            <div class="section-title text-left">
                                ...
                                <h2 class="section-title__title mt-5">Yuva Pension Plan
    </h2>
                            </div>
                         
                            <ul class="list-unstyled about-one__points mt-3">
                                        <p style="font-size:20px;"> Yuva Pension Planning is financial security to young
                                             citizens in their old age. This plan targets youth, encouraging 
                                             them to start saving for their retirement early in their careers.</p>
