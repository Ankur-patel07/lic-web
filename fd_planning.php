                        ...
                        <div class="about-one__left">
                            <div class="about-one__img-box wow slideInLeft" data-wow-delay="100ms"
                                ...
                                <div class="about-one__img">
                                    <img src="assets/images/services/Fix.jpg" alt="">
                                </div>
                    ...
                    <div class="col-xl-6">
                        <div class="about-one__right">
                            <div class="section-title text-left">
                                ...
                                <h2 class="section-title__title mt-5">FD Planning
                            ...
                            <ul class="list-unstyled about-one__points mt-3">
                                <p style="font-size:20px;">
                                  FD (Fixed Deposit) is popular because it offers safe and predictable returns on your money for a fixed period                         
                        </div>
