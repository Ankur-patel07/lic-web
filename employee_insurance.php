...
<head>
    ...
    <title>Employer Employee  insurance </title>
    <!-- favicons Icons -->
        ...
        <section class="page-header">
            ...
            <div class="container">
                <div class="page-header__inner">
                    ...
                    <h2>Employee Employer insurance</h2>
                </div>
            </div>
        </section>
        <!--Page Header End-->
                        ...
                        <div class="about-one__left">
                            <div class="about-one__img-box wow slideInLeft" data-wow-delay="100ms"
                                ...
                                <div class="about-one__img">
                                    <img src="assets/images/services/Employer.jpg" alt="">
                                </div>
                    ...
                    <div class="col-xl-6">
                        <div class="about-one__right">
                            <div class="section-title text-left">
                                ...
                                <h2 class="section-title__title mt-5">Employer Employee Insurance
                            ...
                            <ul class="list-unstyled about-one__points mt-3">
                                ...
                                Employer–employee insurance is a life insurance arrangement where an employer buys a policy for an employee, usually as part of compensation, retention, or tax planning.
                              </ul>
